  ...
  return (
    <div className='header'>
      ...
      <div className='nav-items'>
        <ul>
          <li>Home</li>
          <li><Link to="/about-us" className="btn btn-primary">AboutUs</Link></li>
          <li>Contact Us</li>
          <li>Cart</li>
        </ul>
      </div>
...
const ResCard = ({ restData }) => {
  const { name, totalRatingsString, avgRating, totalRatings, deliveryTime, cuisines, cloudinaryImageId } = restData?.data;
...
const Footer = () => {
  return (
    <div className='footer'>
      <p>© 2023 Food Frenzy</p>
      <p style={{ color: 'red', fontWeight: "bold" }}> Disclaimer!  Please do not order food yet!  Work in Progress!</p>
    </div >
  );
}
export default App;
